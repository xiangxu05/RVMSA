...
"border-radius:12px;")
        ...
        x_axis.setTitleText("时间")  # X 轴标题
        y_axis = QValueAxis()
        y_axis.setRange(0, 1)  # 设置 Y 轴的范围为 -2 到 2
        y_axis.setTitleText("RMVSA")  # Y 轴标题
        # 将 X 和 Y 轴添加到图表中
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_26.setText(_translate("Widget", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">地图可视化</span></p></body></html>"))
